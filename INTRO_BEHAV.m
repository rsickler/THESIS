...
instruct = ['Hello! \n\n' ...
    ...
    'three defenders trying to prevent the ball from hitting the ground and keep you from scoring.'...
...
instruct = ['You will now go through a practice round using the actual scenarios. '...
    ...
    '\n\n Note that this is only a training round, and that the movements you will be instructed to do here are not necessarily the correct movements for each image during the real experiment!'...
