...
p3_stds = 100*[p2_t_O_RATIO_STD p3_t_O_RATIO_STD p4_t_O_RATIO_STD ; p2_t_V_RATIO_STD p3_t_V_RATIO_STD p4_t_V_RATIO_STD]; 
...
for i = 1:nbars
    ...
    errorbar(x, p3_means(:,i), p3_stds(:,i), 'k', 'linestyle', 'none');
end
