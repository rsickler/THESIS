...
%%%%% ---> sujbects 1+2 have huge off values in round 2 training; subjects 3 + 4 it is negligible

pizza = actual_GO_1_2{1}; 
for i = 1:23 
    j = i+1; 
    cheeze(j)= pizza(j)-pizza(i); 
end
...
% reg for 2nd round for subjects 3 and 4 (INCORRECT WAIT)
