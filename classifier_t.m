%Using a separate subject group from AIM (1),
% we will take all the original and variant scenarios as well as
% their corresponding movements and train them in each of them equally.
