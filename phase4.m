...
instruct = ['In this final fouth phase, you will go back to using the joystick as you did at the start of the experiment, with'...
    'trials following the same procedure of examining the image and making the correct joystick movement when prompted with the "GO!" screen. '...
    'In this phase, you will no longer be given feedback on your decisions, but you should continue to try and choose the correct response as you did before.'...
    '\n\n-Would you like to begin Phase 4?' ...
